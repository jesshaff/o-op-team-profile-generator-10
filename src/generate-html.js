...
const generateEngineer = function(engineer) {
    ...
    <div class="card h-100">
        ...
        <div class="card-body">
            ...
            <p class="github">Github: <a href="https://github.com/${engineer.github}" target="-blank" rel="noopener">${engineer.github}</a></p>
        </div>
...
<body>
    <header>
        <nav class="navbar" id="navbar">
            <span class="navbar-brand mb-01 h1 w-100 text-center" id="navbar-text">Team Profile</span>
        </nav>
    </header>
    <main>
        <div class="container">
